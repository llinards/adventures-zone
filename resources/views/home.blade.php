...
@section('content')
    <header>
        <video autoplay muted loop playsinline src="/storage/img/header_video.mp4"
               poster="storage/img/header_img.jpg"></video>
        @include('inc.navbar', ['footer' => $footer, 'locale' => $locale])
        {{-- header --}}
    ...
    <section id="xs-zone" class="section-cards">
        ...
        <div class="container">
            <div class="row">
                ...
                <a href="{{$locale}}/{{ $xszone['slug'] }}"
                   class="col-md-4 section-card-readmore d-flex align-items-center justify-content-around">
