                    ...
                    <div id="right" class="product-page az-menubar d-flex justify-content-around align-items-center">
                        <li class="nav-item">
                            <a class="nav-link text-white text-uppercase"
                               href="/{{$locale}}#cafe">{{__('kafejnica')}}</a>
                        </li>
                        {{--    <li class="nav-item">--}}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto text-center">
                        @if(!empty($product_page))
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase"
                                   href="/{{app()->getLocale()}}#attractions">{{__('atrakcijas')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase"
                                   href="/{{app()->getLocale()}}#party">{{__('ballites')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase"
                                   href="/{{app()->getLocale()}}#values">{{__('vertibas')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase"
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase"
                                   href="#attractions">{{__('atrakcijas')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white text-uppercase" href="#party">{{__('ballites')}}</a>
                            </li>
                    ...
                    <ul class="d-flex justify-content-center">
                        @foreach (config('app.available_locales') as $locale)
                            @if(app()->getLocale() == $locale)
                                <li class="nav-item">
                                    <a class="nav-link text-white text-uppercase"
                                       href="/{{$locale}}">{{ strtoupper($locale) }}</a>
                                </li>
                            @else
                                <li class="nav-item">
                                    <a class="nav-link text-white text-uppercase" style="border-bottom:none;"
                                       href="/{{$locale}}">{{ strtoupper($locale) }}</a>
                                </li>
                            @endif
                        @endforeach
