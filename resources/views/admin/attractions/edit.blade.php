    ...
    <div class="row">
      <div class="col-8 mx-auto">
        <form class="pb-5" action="/admin/{{ $attraction->attraction_slug }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="attraction-cover-img" class="col-form-label"><h4>Pirmās lapas bilde</h4> <span class="text-muted">(Nav obligāts. Šī bilde attiecas tikai uz atrakcijām, t.sk. XS zonu)</span></label>
          ...
          <div class="form-group">
            <label for="attraction-header-img" class="col-form-label"><h4>Header bilde</h4> <span class="text-muted">(Nav obligāts. Sadaļās "Ballītes", "Vērtības" un "Kafejnīca" šī bilde tiek izmantota gan pirmajā lapā, gan kā header bilde.)</span></label>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <textarea class="form-control" name="first-page-description-lat" id="first-page-description-lat" rows="4">{{ $attraction->first_page_description_lat }}</textarea>
              </div>
            </div>
            <div class="col">
              <div class="form-group">
                <label for="first-page-description-eng">ENG</label>
                <textarea class="form-control" name="first-page-description-eng" id="first-page-description-eng" rows="4">{{ $attraction->first_page_description_lat }}</textarea>
              </div>
            </div>
            <div class="col">
              <div class="form-group">
                <label for="first-page-description-rus">RUS</label>
                <textarea class="form-control" name="first-page-description-rus" id="first-page-description-rus" rows="4">{{ $attraction->first_page_description_lat }}</textarea>
              </div>
            </div>
          </div>
